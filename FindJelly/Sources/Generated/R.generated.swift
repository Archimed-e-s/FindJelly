...
struct _R {
  ...
  struct color {
    ...
    var secondaryColor: RswiftResources.ColorResource { .init(name: "SecondaryColor", path: [], bundle: bundle) }

    /// Color `TextFieldsColor`.
    var textFieldsColor: RswiftResources.ColorResource { .init(name: "TextFieldsColor", path: [], bundle: bundle) }

    /// Color `UnreadedMessageColor`.
